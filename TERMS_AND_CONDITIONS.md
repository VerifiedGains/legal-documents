...
You must be:
- A registered Reddit user
- Legally permitted to connect a brokerage account in your jurisdiction

## 4. User Responsibilities

You agree to:
- Provide accurate information
- Not misuse or attempt to manipulate the App
- Not use the App for any illegal purpose
- Comply with Reddit's Terms of Service and Content Policy

## 5. Public Disclosure of Portfolio Data

**IMPORTANT**: By connecting your brokerage account, you explicitly consent to:
- Your portfolio holdings being publicly visible to all Reddit users
- Your trading history being publicly visible to all Reddit users
- Your performance metrics appearing on public leaderboards

This is the core functionality of the App. If you do not want this information public, do not connect your brokerage account.

## 6. Not Financial Advice

**DISCLAIMER**:
- The App is for informational and entertainment purposes only
- Nothing in the App constitutes financial, investment, or trading advice
...
- We are not responsible for:
  - Accuracy of portfolio data displayed
  - Brokerage connection issues
  - Data breaches at third-party services
  - Investment decisions made based on App information
...
- Violation of Reddit's policies
- Any reason at our discretion

You may disconnect your brokerage and stop using the App at any time.
...
These Terms are governed by the laws of the United States. Any disputes shall be resolved in the courts of [Your State/Jurisdiction].
